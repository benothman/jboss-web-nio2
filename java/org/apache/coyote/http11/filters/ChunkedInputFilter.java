...
public class ChunkedInputFilter implements InputFilter {
	...
	/**
	 * Parse the header of a chunk. A chunk header can look like A10CRLF
	 * F23;chunk-extension to be ignoredCRLF The letters before CRLF but after
	 * the trailer mark, must be valid hex digits, we should not parse
	 * F23IAMGONNAMESSTHISUP34CRLF as a valid header according to spec
	 */
