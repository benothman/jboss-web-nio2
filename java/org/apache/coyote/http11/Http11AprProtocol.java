...
public class Http11AprProtocol implements ProtocolHandler, MBeanRegistration {
	...
	protected static org.jboss.logging.Logger log = org.jboss.logging.Logger
			.getLogger(Http11AprProtocol.class);
	...
	static class Http11ConnectionHandler implements Handler {
		...
		protected ConcurrentHashMap<Long, Http11AprProcessor> connections = new ConcurrentHashMap<Long, Http11AprProcessor>();
		...
		public SocketState process(long socket) {
			...
			try {
				...
				// IOExceptions are normal
				Http11AprProtocol.log.debug(sm.getString("http11protocol.proto.ioexception.debug"),
						e);
			}
			// Future developers: if you discover any other
			// rare-but-nonfatal exceptions, catch them here, and log as
		...
		protected Http11AprProcessor createProcessor() {
			Http11AprProcessor processor = new Http11AprProcessor(proto.maxHttpHeaderSize,
					proto.endpoint);
