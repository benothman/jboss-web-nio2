...
public class MbeansDescriptorsIntrospectionSource extends ModelerSource {
	...
	static Hashtable<Object, Object> specialMethods = new Hashtable<Object, Object>();
	static {
	...
	private static Class[] supportedTypes = new Class[] { Boolean.class, Boolean.TYPE, Byte.class,
			Byte.TYPE, Character.class, Character.TYPE, Short.class, Short.TYPE, Integer.class,
			Integer.TYPE, Long.class, Long.TYPE, Float.class, Float.TYPE, Double.class,
			Double.TYPE, String.class, strArray.getClass(), BigDecimal.class, BigInteger.class,
			ObjectName.class, objNameArray.getClass(), java.io.File.class, };
	 ...
	 * @param getAttMap
	 *            The readable attributess map
	 * @param setAttMap
	 *            The settable attributes map
	 * @param invokeAttMap
	 *            The invokable attributes map
	 */
	private void initMethods(Class realClass, Method methods[], Hashtable attMap,
			Hashtable getAttMap, Hashtable setAttMap, Hashtable invokeAttMap) {
	 ...
	 */
	public ManagedBean createManagedBean(Registry registry, String domain, Class realClass,
			String type) {
