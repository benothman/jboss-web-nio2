 ...
 * @version $Revision: 1842 $ $Date: 2011-09-23 18:47:53 +0200 (Fri, 23 Sep
 *          2011) $
 */
...
public class Connector implements Lifecycle, MBeanRegistration {
	...
	public static final boolean RECYCLE_FACADES = Boolean.valueOf(
			System.getProperty("org.apache.catalina.connector.RECYCLE_FACADES",
					(org.apache.tomcat.util.Constants.LOW_MEMORY) ? "true" : "false"))
			.booleanValue();
	...
	protected static final String URI_ENCODING = System
			.getProperty("org.apache.catalina.connector.URI_ENCODING");
	...
	protected ObjectName createObjectName(String domain, String type)
		...
		ObjectName _oname = new ObjectName(domain + ":type=" + type + ",port=" + getPort()
				+ addSuffix);
		return _oname;
	}
