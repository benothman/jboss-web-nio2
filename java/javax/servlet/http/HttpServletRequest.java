...
public interface HttpServletRequest extends ServletRequest {
	 ...
	 * <code>ServletContext</code> to authenticate the user making this request.
	 * 
	 * <p>
	 ...
	 * 
	 * @param response
	 *            The <code>HttpServletResponse</code> associated with this
	 *            <code>HttpServletRequest</code>
	 * 
	 * @return <code>true</code> when non-null values were or have been
	 *         established as the values returned by
	 *         <code>getUserPrincipal</code>, <code>getRemoteUser</code>, and
	 *         <code>getAuthType</code>. Return <code>false</code> if
	 *         authentication is incomplete and the underlying login mechanism
	 *         has committed, in the response, the message (e.g., challenge) and
	 *         HTTP status code to be returned to the user.
	 * 
	 * @throws IOException
	 *             if an input or output error occurred while reading from this
	 *             request or writing to the given response
	 * 
	 * @throws IllegalStateException
	 *             if the login mechanism attempted to modify the response and
	 *             it was already committed
	 * 
	 * @throws ServletException
	 *             if the authentication failed and the caller is responsible
	 *             for handling the error (i.e., the underlying login mechanism
	 *             did NOT establish the message and HTTP status code to be
	 ...
	 * 
	 * <p>
	 * This method returns without throwing a <code>ServletException</code> when
	 * the login mechanism configured for the <code>ServletContext</code>
	 * supports username password validation, and when, at the time of the call
	 * to login, the identity of the caller of the request had not been
	 * established (i.e, all of <code>getUserPrincipal</code>,
	 * <code>getRemoteUser</code>, and <code>getAuthType</code> return null),
	 * and when validation of the provided credentials is successful. Otherwise,
	 * this method throws a <code>ServletException</code> as described below.
	 * 
	 * <p>
	 * When this method returns without throwing an exception, it must have
	 * established non-null values as the values returned by
	 * <code>getUserPrincipal</code>, <code>getRemoteUser</code>, and
	 * <code>getAuthType</code>.
	 * 
	 * @param username
	 *            The <code>String</code> value corresponding to the login
	 *            identifier of the user.
	 * 
	 * @param password
	 *            The password <code>String</code> corresponding to the
	 *            identified user.
	 * 
	 * @exception ServletException
	 *                if the configured login mechanism does not support
	 *                username password authentication, or if a non-null caller
	 *                identity had already been established (prior to the call
	 *                to login), or if validation of the provided username and
	 *                password fails.
	 * 
	 * @since Servlet 3.0
	 */
	...
	/**
	 * Gets all the {@link Part} components of this request, provided that it is
	 ...
	 * <code>HttpServletRequest</code>.
	 * 
	 * @return a (possibly empty) <code>Collection</code> of the Part components
	 *         of this request
	 * 
	 * @throws IOException
	 *             if an I/O error occurred during the retrieval of the
	 *             {@link Part} components of this request
	 * 
	 * @throws ServletException
	 *             if this request is not of type <tt>multipart/form-data</tt>
	 * 
	 * @throws IllegalStateException
	 *             if the request body is larger than <tt>maxRequestSize</tt>,
	 *             or any Part in the request is larger than
	 *             <tt>maxFileSize</tt>
	 * 
	 ...
	 * 
	 * @return The Part with the given name, or <tt>null</tt> if this request is
